...
here as one file. The rebuild's rationale (the deliberate refinements over
Magesty.jl) predates this directory and stays at
...
|---|---|---|
| `docs/specs/` | Agreed-on, in-progress, or completed development units (`requirements.md` / `design.md` / `tasklist.md`) | `docs/specs/260901-<slug>/` |
