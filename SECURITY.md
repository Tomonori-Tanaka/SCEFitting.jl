...
SCEFitting.jl is a numerical Julia package. Only the latest released minor
...
SCEFitting.jl processes user-supplied TOML inputs and model files, extxyz /
EMBSET data files, and VASP outputs through its readers. Issues that allow code
